...
const buttonClass =
  "sm:w-[6rem] md:w-fit text-inherit leading-4 text-btn-txt text-sm sm:text-base bg-btn-bg rounded py-2 px-2 lg:px-6 cursor-pointer decoration-none hover:bg-btn-act active:bg-btn-act";
